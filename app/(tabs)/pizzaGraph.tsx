    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceValue}>R$ 1.950,00</Text>
        </View>
        ...
        <View style={styles.summary}>
          <View style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue}>Aluguel</Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Categoria</Text>

            <Text style={styles.summaryValue}>Moradia</Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Total</Text>

            <Text style={styles.summaryValue}>R$ 1.950</Text>
          </View>
        </View>
